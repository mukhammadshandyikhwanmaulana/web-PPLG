...
<div class="max-w-7xl mx-auto space-y-4 sm:space-y-6 px-4 sm:px-6 lg:px-8 py-4">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <h1 class="text-xl sm:text-2xl font-bold tracking-tight text-slate-900">Edit FAQ</h1>
            <p class="mt-0.5 text-xs sm:text-sm text-slate-500">Perbarui pertanyaan dan jawaban FAQ ini.</p>
        </div>
    </div>
