...
<div class="max-w-3xl mx-auto py-4 sm:py-6 px-3 sm:px-6">
    ...
    <div class="mb-5">
        <h1 class="text-xl sm:text-2xl font-bold text-gray-900 tracking-tight">Edit Mitra</h1>
        <p class="mt-0.5 text-xs sm:text-sm text-gray-500">Perbarui informasi mitra ini.</p>
    </div>

    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
        <form method="POST" action="{{ route('admin.mitra.update', $partner) }}" enctype="multipart/form-data" class="space-y-6">
            @csrf
            @method('PUT')
